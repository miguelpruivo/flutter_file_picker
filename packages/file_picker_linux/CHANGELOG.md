...
- Replaced the placeholder example with a runnable Flutter app that demonstrates resolving `parentWindow` at runtime, which is what makes `lockParentWindow` lock anything.
