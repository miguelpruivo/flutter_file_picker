...
This package defines the interface that all platform implementation packages for `file_picker` (such as `android_file_picker`, `file_picker_darwin`, `file_picker_windows`, `file_picker_linux`, `file_picker_web`) must implement.
