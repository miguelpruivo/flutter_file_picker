...
Before creating an issue, make sure that you are on the latest `file_picker` version and that there aren't already any similar [opened issues](https://github.com/vicajilau/flutter_file_picker/issues).
